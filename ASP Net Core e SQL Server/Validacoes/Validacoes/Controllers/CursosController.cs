...
namespace Validacoes.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Categoria")] Cursos cursos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Categoria")] Cursos cursos)
        {
            if (id != cursos.Id)
            {
                return NotFound();
